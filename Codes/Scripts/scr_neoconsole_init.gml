 function scr_neoconsole_init()
{
    ...
    ds_map_add(commandsMap, "clear_achievements", "scr_neoconsole_clear_steam")
    ds_map_add(commandsMap, "unlock_achievement", "scr_neoconsole_unlock_steam")
    ...
    ds_map_add(helpSyntaxMap, "clear_achievements", "clear_achievements")
    ds_map_add(helpSyntaxMap, "unlock_achievement", "unlock_achievement [id | mode]")
    ...
    ds_map_add(helpSyntaxMap, "questnextarget", "questnextarget [quest_key]")
    ...
    ds_map_add(helpUsageMap, "rep", ["Arguments :", "    city_name : The name of the city with which you want to change your reputation. ('osbrook', 'mannshire', 'willow', 'brynn', 'all')", "    amount : The amount of reputation. Can be negative.", "Description :", "Changes reputation with the specified city."])
    ...
    ds_map_add(helpUsageMap, "lvl", ["Arguments :", "    value : The level to the player to.", "Description :", "Sets player's level to provided value."])
    ...
    ds_map_add(helpUsageMap, "questnexttarget", ["Arguments :", "    qiest_key : Quest identifier.", "Description :", "Makes given quest change target for the next one. (?)"])
